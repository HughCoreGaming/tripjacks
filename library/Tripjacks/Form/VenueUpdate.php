...
class Tripjacks_Form_VenueUpdate extends Tripjacks_Form_VenueCreate {
    ...
    public function init() {
        ...
        $this->setAction('/admin/venues/venue/update');
        ...
        // create hidden input for venue ID
        $venueid = new Zend_Form_Element_Hidden('venueid');
        ...
        $submit->setLabel('Update Venue')
                ->setOptions(array('class' => 'submit'));


        // attach elements to form
        $this->addElement($venueid)
                ->addElement($name)
                ->addElement($address)
                ->addElement($town)
                ->addElement($county)
